    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(null=True, upload_to=user.models.profile_picture_file_path)),
                ('bio', models.CharField(max_length=127)),
                ('followers', models.ManyToManyField(related_name='followers', to=settings.AUTH_USER_MODEL)),
                ('following', models.ManyToManyField(related_name='user_follows', to=settings.AUTH_USER_MODEL)),
